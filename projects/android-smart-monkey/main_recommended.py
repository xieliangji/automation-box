...
from smart_monkey.app_recommended import SmartMonkeyAppRecommended
...
def main() -> None:
    ...
    app = SmartMonkeyAppRecommended(driver=driver, config=config, output_dir=Path("output/recommended_run"))
    app.run()
