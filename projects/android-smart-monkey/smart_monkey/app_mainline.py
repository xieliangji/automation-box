...
class SmartMonkeyAppMainline(WatchdogSmartMonkeyApp):
    ...
    def run(self) -> None:
        ...
        for step in range(self.config.run.max_steps):
            ...
            if transition.out_of_app or self.should_escape(previous_state, current_state, next_state, transition):
                self._recover_mainline(current_state.state_id, transition.out_of_app)
    ...
    def _recover_mainline(self, current_state_id: str, out_of_app: bool) -> None:
